...
from ml.neural.format import default_preprocess_obss
...
class BaseAlgo(RLAgent):
    ...
    def __init__(self, num_frames_per_proc, gamma, lr, gae_lambda, entropy_coef,
        ...
        self.model_dir = utils.get_model_dir(env_name=env_name, model_name=problem_name, class_name=self.class_name())
