...
def run_graml_point_maze_tutorial():
    ...
    actor = DeepRLAgent(domain_name="point_maze", problem_name="PointMaze-FourRoomsEnvDense-11x11-Goal-4x4", env_prop=env_property, algorithm=TD3, num_timesteps=200000)
    actor.learn()
